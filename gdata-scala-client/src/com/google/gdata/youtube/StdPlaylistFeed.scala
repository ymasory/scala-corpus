...
/**
 * A concrete, standard playlist feed. It feeds a playlist as a sequence of video entries,
 * ordered by a 'position' field.
 * 
 * @author Iulian Dragos
 */
class StdPlaylistFeed extends AtomFeeds with MediaRss with PlaylistVideoEntries {
  type Feed = AtomFeed
